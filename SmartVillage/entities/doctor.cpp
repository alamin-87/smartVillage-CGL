...
Doctor::Doctor(float startX, float startY) {
    posX = startX;
    posY = startY;
    speed = 0.005f;
    legAngle = 0.0f;
...
void Doctor::render() {
    ...
    float scale = 0.5f; // Even smaller height
    ...
    // Stethoscope (Black lines)
    glColor3f(0.1f, 0.1f, 0.1f);
    drawBresenhamLine(-0.02f, 0.16f, 0.0f, 0.10f);
    drawBresenhamLine( 0.02f, 0.16f, 0.0f, 0.10f);
    fillMidpointCircle(0.0f, 0.08f, 0.01f); // End piece
    ...
    // Glasses for doctor effect
    glColor3f(0.1f, 0.1f, 0.1f);
    drawBresenhamLine(-0.03f, 0.015f, -0.01f, 0.015f);
    drawBresenhamLine(0.01f, 0.015f, 0.03f, 0.015f);
    drawBresenhamLine(-0.01f, 0.015f, 0.01f, 0.015f);
    glPopMatrix();

    // Walking Legs (Dark Blue Trousers)
    ...
    glColor3f(1.0f, 1.0f, 1.0f); // White sleeves
    glPushMatrix();
